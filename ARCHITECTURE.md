...
+ Move left: A key
+ Move right: D key
+ [Soft Drop](https://tetris.wiki/Drop#Soft_drop): W key
+ [Sonic Drop](https://tetris.wiki/Drop#Instant_drop): Space key
+ Rotate clockwise: K key
+ Rotate counterclockwise: J key
